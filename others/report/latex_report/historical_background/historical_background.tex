...
The game was introduced through a Belgian patent entitled Tricolor~\cite{kraitchik1930tricolor}. The original patent document, reproduced in~\ref{fig:certificate_brevet}, presents the rules of the game, the board geometry, and the initial arrangement of the pieces. Tricolor was later included in Kraitchik’s book \textit{La mathématique des jeux ou récréations mathématiques}~\cite{kraitchik1930mathematique}, which is discussed in more detail in the next section.
...
\begin{figure}[h]
    ...
    \caption{Tricolor board and pieces}
...
Kraitchik’s later presentation of Tricolor in \textit{La mathématique des jeux ou récréations mathématiques} provides the main historical description of the game beyond the patent~\cite{kraitchik1930mathematique}. In this book, Tricolor is included among a broader collection of mathematical recreations, which situates it within Kraitchik’s general interest in games, puzzles, and recreational mathematics.
...
\begin{figure}[h]
    ...
    \caption{Example of a Tricolor game played between two players}
