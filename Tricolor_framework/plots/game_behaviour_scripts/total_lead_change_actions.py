...
path1 = "../../csv_files/game_behaviour_" + args[0] + "_vs_" + args[1] + "/total_lead_change_actions.csv"
df = pd.read_csv(path1)

if args[0] != args[1]:
    path2 = "../../csv_files/game_behaviour_" + args[1] + "_vs_" + args[0] + "/total_lead_change_actions.csv"
...
plt.savefig("../game_behaviour" + "_" + args[0] + "_vs_" + args[1] + "/total_lead_change_actions.pdf")